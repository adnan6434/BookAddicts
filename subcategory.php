        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12" >
					...
					$sql="SELECT* from Subcategory,productinfo where subcategory.SubcategoryID=$sid";
					$r=mysqli_query($conn,$sql);
					$field=mysqli_fetch_assoc($r);
					$sname=$field["Subcategory"];
					echo"<h3>".$sname."</h3>";
					$sql1="SELECT* from Subcategory,productinfo where subcategory.SubcategoryID=$sid and subcategory.SubcategoryID=productinfo.SubcategoryID";
					$r1=mysqli_query($conn,$sql1);
					while($field=mysqli_fetch_assoc($r1))
					{
						$pid=$field["ProductID"];
						$pname=$field["ProductName"];
						echo "<p><a href="."'product.php?ProductID=".$pid."'>".$pname."</a></p>";
