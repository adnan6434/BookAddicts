    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            if(isset($_POST['supplierregister']))
            {
            	...
            	$sql = "INSERT INTO supplierinfo (SupplierName,SupplierContactNO)
                   VALUES ('$sname','$con')";
            ...
            ?>
            <form id="add_form" method="POST" action="addsupplier.php">
            	<fieldset>
            	...
            	<?php if(isset($_GET['error'])): ?>
            		...
            		<p>
            			...
            			<input id="supplier"  name="suppliername" type="text" required="true" />
            		</p>
                    <p>
            			<label for="con">Contact NO</label>
            			<input style="margin-left:34px;"id="con"  name="contact" type="text" required="true" />
            		</p>

            <p>
            	<input type="submit" value="register" name="supplierregister">
            </p>
            </fieldset>
            	</form>
