    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            if(isset($_POST['adminregister']))
            {
            	...
            	$sql = "INSERT INTO userinfo (FirstName,LastName, UserName,ContactNo,Role, Password,JoinDate )
                   VALUES ('$firstname','$lastname','$username','$contact','$role','$password',CURRENT_TIMESTAMP)";
            ...
            ?>
            <form id="add_form" method="POST" action="addemployee.php">
            	<fieldset>
            	...
            	<?php if(isset($_GET['error'])): ?>
                    ...
                    <p>
            			...
            			<input id="contactno"  name="contactno" type="text"  required="true" />
