...
<body style="background:#808080;">
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
			...
			{
			$eid=$_GET['eid'];
			$sql="SELECT * from userinfo where userID=$eid";
            ...
            ?>
            <form id="add_form" method="POST" action="updateemployee.php">
            	<fieldset>
            	<legend>Edit Employee Record</legend>
			 ...
			 value="<?php echo $eid;?>" />
                    ...
                    <p>
            			...
            			<input id="contactno"  name="contactno" type="text"value="<?php echo $contact;?>"  required="true" />
