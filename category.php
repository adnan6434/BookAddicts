        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12" >
					...
					$sql="SELECT* from categories,Subcategory where categories.CategoryID=$cid and categories.CategoryID=Subcategory.CategoryID";
					$r=mysqli_query($conn,$sql);
					$field=mysqli_fetch_assoc($r);
					$cname=$field["CategoryName"];
					echo"<h3>".$cname."</h3>";
					$sql1="SELECT* from categories,Subcategory where categories.CategoryID=$cid and categories.CategoryID=Subcategory.CategoryID";
					$r1=mysqli_query($conn,$sql1);
					while($field=mysqli_fetch_assoc($r1))
					{
						$sid=$field["SubcategoryID"];
						$sname=$field["Subcategory"];
						echo "<p><a href="."'subcategory.php?SubcategoryID=".$sid."'>".$sname."</a></]>";
