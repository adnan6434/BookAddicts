        ...
        <div class="container">
            ...
            <form id="add_form" method="POST" action="updatecategory.php">
             ...
             <p>
                 ...
                 <input id="category"  name="categoryname" type="text" value="<?php echo $cname;?>" required="true" />
             </p>

            <p>
            	<input type="submit" value="update" name="categoryupdate">
            </p>
            </fieldset>
            	</form>
