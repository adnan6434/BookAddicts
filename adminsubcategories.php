...
<thead id="thl"><tr>
	<th style="font-weight:bold"><b>SubcategoryID</b></th>
	<th style="font-weight:bold;"><b>SubcategoryName</b></th>
    <th style="font-weight:bold"><b>CategoryID</b></th>
    <th style="font-weight:bold;"><b>CategoryName</b></th>
	</tr></thead>
	<form id="delete_subcategory" method="POST" action="deletesubcategory.php">
	<tbody>
		<?php
		$sql="SELECT* from categories,subcategory WHERE subcategory.CategoryID=categories.CategoryID";
		...
		while($field=mysqli_fetch_assoc($r))
		{
			...
			echo "<td>".$cname."</td>";
			 ...
			 echo "<td>"."<a href='updatesubcategory.php?sid=".$sid."'>"."EDIT"."</a></td>";
			 echo "<td>"."<input type='checkbox' name='SID' value='$sid'></input>"."</td>" ;
...
<input type="submit" name="delete" value="delete" style="float:right;background:#fc464c;color:#67fc87;">
 ...
 <p style="font-size:20px;">***NOTE:To delete any Subcategory , select corresponding checkbox and click the delete button</p>
		</div>
	</body>
</html>
