...
<body style="background:#808080;">
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <?php
            if(isset($_POST['subcategoryregister']))
            {
            	...
            	$sql = "INSERT INTO subcategory (Subcategory,CategoryID)
            ...
            ?>
            <form id="add_form" method="POST" action="addsubcategory.php">
            	<fieldset>
            	<legend>Add a Subcategory</legend>
            	...
            	<?php if(isset($_GET['error'])): ?>
            		...
            		<p>
            			...
            			<input id="subcategory"  name="subcategoryname" type="text" required="true" />
            		</p>
                    <p>
            			<label for="category">CategoryID</label>
            			<input style="margin-left:22px;"id="category"  name="categoryid" type="text" required="true" />
            		</p>

            <p>
            	<input type="submit" value="register" name="subcategoryregister">
            </p>
            </fieldset>
            	</form>
