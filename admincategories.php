...
<thead id="thl"><tr>
	...
	<form id="delete_category" method="POST" action="deletecategory.php">
	<tbody>
		<?php
		...
		while($field=mysqli_fetch_assoc($r))
		{
			...
			echo "<td>".$cname."</td>";
			 ...
			 echo "<td>"."<a href='updatecategory.php?cid=".$cid."'>"."EDIT"."</a></td>";
			 echo "<td>"."<input type='checkbox' name='CID' value='$cid'></input>"."</td>" ;
